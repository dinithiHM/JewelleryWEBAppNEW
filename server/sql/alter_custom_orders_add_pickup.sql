-- Alter custom_orders table to add pickup functionality
-- 1. Modify the order_status ENUM to include "Picked Up"
ALTER TABLE custom_orders 
MODIFY COLUMN order_status ENUM('Pending', 'In Progress', 'Completed', 'Picked Up', 'Delivered', 'Cancelled') DEFAULT 'Pending';

-- 2. Add pickup_date and pickup_notes columns
ALTER TABLE custom_orders
ADD COLUMN pickup_date DATETIME NULL,
ADD COLUMN pickup_notes TEXT NULL;

-- 3. Update the custom_order_details view to include the new columns
